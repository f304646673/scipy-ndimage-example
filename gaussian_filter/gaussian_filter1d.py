...
def gaussian_filter(red, green, blue, sigma):
    redGaussian =  ndimage.gaussian_filter1d(red, sigma=sigma)
    greenGaussian = ndimage.gaussian_filter1d(green, sigma=sigma)
    blueGaussian =  ndimage.gaussian_filter1d(blue, sigma=sigma)
...
Image.fromarray(full3D).save('gaussian_filter1d.png')